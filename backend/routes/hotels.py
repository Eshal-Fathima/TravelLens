...
def create_hotel():
    """Create a new hotel"""
    try:
        current_user_id = int(get_jwt_identity())  # JWT returns string, cast to int
        ...
        # Cast to correct types explicitly
        ...
        db.session.rollback()
        import traceback; traceback.print_exc()  # prints full error in terminal
